...
ALTER SEQUENCE exam_sign_up_id_seq RESTART WITH 4400;
ALTER SEQUENCE enrolment_id_seq RESTART WITH 500;
ALTER SEQUENCE enrolment_token_id_seq RESTART WITH 500;
